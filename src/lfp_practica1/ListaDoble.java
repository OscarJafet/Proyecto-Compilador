...
public class ListaDoble {
 NodoDeListaDoble primernodo, Ultimonodo, recorrer;
    void inicializar(){
    ...
    void insertarAlInicio(String dato,String token){
        if(vacia()){
            this.Ultimonodo=this.primernodo= new NodoDeListaDoble(dato,token);
        }else{
                  NodoDeListaDoble aux= new NodoDeListaDoble(null, this.primernodo, dato,token);
    ...
    void InsertarAlfinal(String dato,String token){
        if(vacia()){
          ...
          this.Ultimonodo.setSiguiente(new NodoDeListaDoble(Ultimonodo,null, dato,token));
...
//           }
  ...
  if(vacia()){
      ...
      for (NodoDeListaDoble i = primernodo; i !=null ; i=i.Siguiente) {
          System.out.println(i.getDato()+"---->"+i.getToken());
      }
     }
  }
